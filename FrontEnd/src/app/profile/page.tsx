...
import { AuthUser, getAuthUser, logout } from "@/lib/api";
                        ...
                        >
                            ...
                            <div className="text-center sm:text-left">
                                ...
                                <p className="text-base sm:text-lg text-gray-500 font-bold">
                                    @{user.username} &middot; {user.university}
                                </p>
                                ...
                                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4">
                                    ...
                                    <div className="text-center sm:text-left">
                                        ...
                                        <p className="text-white/50 text-sm sm:text-base font-medium leading-relaxed mb-4">
                                            Join your first course room to start
                                            building your academic network.
                                            Activity and stats will appear
                                            here.
                                        </p>
                                        <Link
                                            href="/discover"
                        ...
                        >
                            <div className="text-center sm:text-left">
                                ...
                                <p className="text-white/70 text-sm sm:text-base font-medium">
                                    Kampus is better with friends. Share your
                                    link!
                                </p>
                            </div>
